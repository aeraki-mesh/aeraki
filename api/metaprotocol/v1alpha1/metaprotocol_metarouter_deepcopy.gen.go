...
// DeepCopyInto supports using LocalRateLimitCondition within kubernetes types, where deepcopy-gen is used.
func (in *LocalRateLimitCondition) DeepCopyInto(out *LocalRateLimitCondition) {
	p := proto.Clone(in).(*LocalRateLimitCondition)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalRateLimitCondition. Required by controller-gen.
func (in *LocalRateLimitCondition) DeepCopy() *LocalRateLimitCondition {
	if in == nil {
		return nil
	}
	out := new(LocalRateLimitCondition)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LocalRateLimitCondition. Required by controller-gen.
func (in *LocalRateLimitCondition) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
