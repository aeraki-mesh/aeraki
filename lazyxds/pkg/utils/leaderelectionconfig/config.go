...
// New creates a LeaderElectionConfiguration
func New(name string) *componentbaseconfig.LeaderElectionConfiguration {
...
func AddFlags(l *componentbaseconfig.LeaderElectionConfiguration, fs *pflag.FlagSet) {
