...
func TestKafkaSidecarOutboundConfig(t *testing.T) {
	...
	if !strings.Contains(config, want) {
		t.Errorf("can't find kafaka filter in the outbound listener of the envoy sidecar: conf \n %s, want \n %s", config, want)
	}
}
...
func TestKafkaSidecarInboundConfig(t *testing.T) {
	...
	want = strings.Join(strings.Fields(want), "")
	if !strings.Contains(config, want) {
		t.Errorf("can't find kafka filter in the inbound listener of the envoy sidecar: conf \n %s, want \n %s", config, want)
	}
}
...
func TestZookeeperSidecarOutboundConfig(t *testing.T) {
	...
	want = strings.Join(strings.Fields(want), "")
	if !strings.Contains(config, want) {
		t.Errorf("can't find zookeeper filter in the outbound listener of the envoy sidecar: conf \n %s, want \n %s", config, want)
	}
}
...
func TestZookeeperSidecarInboundConfig(t *testing.T) {
	...
	want = strings.Join(strings.Fields(want), "")
	if !strings.Contains(config, want) {
		t.Errorf("can't find zookeeper filter in the inbound listener of the envoy sidecar: conf \n %s, want \n %s", config, want)
	}
}
