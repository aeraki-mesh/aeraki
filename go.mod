...
// Istio 1.16.5 modules
replace github.com/envoyproxy/go-control-plane => github.com/envoyproxy/go-control-plane v0.10.3-0.20220908185826-2b9739221838

replace istio.io/api => istio.io/api v0.0.0-20230518153929-d0aebaa77ab8

replace istio.io/client-go => istio.io/client-go v1.16.5

replace istio.io/istio => istio.io/istio v0.0.0-20230519000352-ae8d5164776c

replace istio.io/pkg => istio.io/pkg v0.0.0-20221107183613-574f8d141535
...
require (
	github.com/aeraki-mesh/api v1.3.0
