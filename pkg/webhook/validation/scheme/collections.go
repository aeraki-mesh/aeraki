...
var (
	...
	AerakiMetaprotocolV1Alpha1Applicationprotocols = collection.Builder{
		...
		Resource: resource.Builder{
			...
			ReflectType: reflect.TypeOf(&githubcomaerakimeshaerakiapimetaprotocolv1alpha1.ApplicationProtocol{}).Elem(), StatusType: reflect.TypeOf(&istioioapimetav1alpha1.IstioStatus{}).Elem(),
